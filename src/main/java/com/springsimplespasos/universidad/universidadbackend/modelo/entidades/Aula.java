...
public class Aula implements Serializable {
    ...
    public Aula(Integer id, Integer nroAula, String medadidas, Integer cantidadPupitres, Pizarron pizarron, LocalDateTime fechaAlta, LocalDateTime fechaModificacion) {
        this.id = id;
        this.nroAula = nroAula;
        this.medidas = medadidas;
